import { useMemo, type ChangeEvent, type JSX, type SyntheticEvent } from 'react';
  ...
  return (
    <section className="rfd-editor" aria-label="Rule Detail Editor">
      <form className="rfd-form" onSubmit={preventSubmit}>
        <RuleHeader isSaving={isSaving} onSave={onSave} />
        ...
        <RuleTextareas editorState={editorState} onFieldChange={onFieldChange} />
 ...
 */
function RuleHeader(props: { isSaving: boolean; onSave: () => void }): JSX.Element {
